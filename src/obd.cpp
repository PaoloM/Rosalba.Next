...
void initializeCAN() {
  ...
  // Start CAN bus at configured speed
  if (!CAN.begin(CAN_SPEED)) {
    Serial.println("ERROR: Failed to initialize CAN bus!");
    Serial.println("Check wiring:");
    Serial.println("- ESP32 GPIO21 (TX) -> SN65HVD230 D pin");
    Serial.println("- ESP32 GPIO22 (RX) -> SN65HVD230 R pin");
...
void sendOBDRequest(uint8_t pid) {
  CAN.beginPacket(0x7DF); // Standard OBD-II request ID
